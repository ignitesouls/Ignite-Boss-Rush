...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 9005810, 2044450800, 76945, 2044450951, 2044451951, 5);
    ...
    $InitializeEvent(0, 2044450800);
    $InitializeEvent(0, 2044452810);
    $InitializeEvent(0, 2044452811);
    $InitializeEvent(0, 2044452849);
    $InitializeEvent(0, 2044452820);
    $InitializeEvent(0, 2044452821);
...
L0:
    EndIf(!EventFlag(1049308176) && !EventFlag(1049309744) && !EventFlag(1049309745)); //end if boss not selected
    ...
    if (EventFlag(1049308176)) //full fight
        $InitializeCommonEvent(0, 90009810, 1049307576);
    else if (EventFlag(1049309744)) //phase 2 restore hp
        $InitializeCommonEvent(0, 90009810, 1049307744);
    else if (EventFlag(1049309745)) //phase 2 normal hp
        $InitializeCommonEvent(0, 90009810, 1049307745);
});
...
L2:
    ...
    if (EventFlag(1049309744) || EventFlag(1049309745)) //if phase 2 selected
        SetSpEffect(2044450800, 10493045);
...
$Event(2044452811, Restart, function() {
    ...
    if (EventFlag(1049309744)) //if phase 2 & restore hp
        SetSpEffect(2044450800, 10493050);
});
