...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 2051442800);
    $InitializeEvent(0, 2051442810);
    $InitializeEvent(0, 2051442849);
    ...
    $InitializeCommonEvent(0, 90005301, 2051440300, 2051440300, 2051440500, 3, 0);
    $InitializeCommonEvent(0, 90005301, 2051440310, 2051440310, 2051440510, 3, 0);
...
$Event(2051442800, Restart, function() {
    EndIf(!EventFlag(1049308206)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307606);
});
