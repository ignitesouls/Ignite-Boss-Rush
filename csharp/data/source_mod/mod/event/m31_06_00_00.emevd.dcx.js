...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 31062800);
    $InitializeEvent(0, 31062801);
    $InitializeEvent(0, 31062802);
    $InitializeEvent(0, 31062810);
    $InitializeEvent(0, 31062849);
    $InitializeEvent(0, 31062811);
    ...
    $InitializeCommonEvent(0, 90005646, 31060800, 31062840, 31062841, 31061840, 31062840, 31, 6, 0, 0);
    $InitializeCommonEvent(0, 91005600, 31062800, 31061695, 5);
});

// プリコンストラクタ -- preconstructor
$Event(50, Default, function() {
    $InitializeCommonEvent(0, 90005261, 31060200, 31062200, 2, 1, 0);
    $InitializeCommonEvent(0, 90005261, 31060201, 31062200, 2, 1.2, 0);
    $InitializeCommonEvent(0, 90005261, 31060202, 31062200, 2, 1.4, 0);
    $InitializeCommonEvent(0, 90005261, 31060203, 31062203, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060204, 31062203, 2, 0.2, 0);
    $InitializeCommonEvent(0, 90005261, 31060205, 31062205, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060211, 31062211, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060212, 31062211, 2, 0.2, 0);
    $InitializeCommonEvent(0, 90005261, 31060215, 31062215, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060280, 31062280, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060281, 31062281, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060282, 31062281, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060283, 31062283, 2, 0, 0);
    $InitializeCommonEvent(0, 90005261, 31060300, 31062300, 2, 0, 0);
});

// はぐれ輝石魔術師_巡回ルート変更 -- Stray pyroxene magician_Changed patrol route
...
$Event(31062800, Restart, function() {
    EndIf(!EventFlag(1049308141)); //end if boss not selected
    ...
    InitializeCommonEvent(0, 90001033, 1049304147, 1049304049, 1049304045, -1, 1049304610, 1049304611, 1049304612, 1049304613, -1, 1049304744, 1049304746, 1049304749, 1049300147);
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307541);
});
