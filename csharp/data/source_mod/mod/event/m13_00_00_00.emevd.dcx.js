...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90005780, 13000850, 13002160, 13002161, 13000720, SummonSignType.NPCWhiteSign, 13002721, 0, true, 0); //enable summon sign visibility
    $InitializeCommonEvent(0, 90005781, 13000850, 13002160, 13002161, 13000720);
    $InitializeEvent(0, 13002859);
    $InitializeCommonEvent(0, 90005780, 13000850, 13002164, 13002165, 13000725, SummonSignType.NPCWhiteSign, 13002726, 0, true, 0); //enable summon sign visibility
...
$Event(50, Default, function() {
    if (EventFlag(1049308011)) //change weather if placidusax selected
...
L0:
    EndIf(!EventFlag(1049308009) && !EventFlag(1049309702) && !EventFlag(1049309703)); //end if boss not selected
    ...
    if (EventFlag(1049300500)) //if full death dialogue enabled
        ...
        WaitFor(
            (PlayerIsInOwnWorld() && CharacterDead(13000800))
                || EventFlag(13000800));
    ...
    InitializeCommonEvent(0, 90001034, 1049304248, 1049307060, -1, 1049304008, 1049307061, 1049307062, 1049307063, 1049307064, 1049307065, 1049305931, 1049305934, 1049305936, 1049305941, 1049305943, 1049300248);
    //boss defeat and warp
    if (EventFlag(1049308009)) //full fight
        $InitializeCommonEvent(0, 90009810, 1049307409);
    else if (EventFlag(1049309702)) //phase 2 restore hp
        $InitializeCommonEvent(0, 90009810, 1049307702);
    else if (EventFlag(1049309703)) //phase 2 normal hp
        $InitializeCommonEvent(0, 90009810, 1049307703);
});
...
L2:
    ...
    if (EventFlag(1049309702) || EventFlag(1049309703)) { //if phase 2 selected
        SetSpEffect(13000801, 10493044);
    }
...
$Event(13002811, Restart, function() {
    ...
    SetNetworkUpdateRate(13000800, true, CharacterUpdateFrequency.AlwaysUpdate);
    if (EventFlag(1049309702)) //if phase 2 & restore hp
        SetSpEffect(13000800, 10493050);
...
$Event(13002830, Restart, function() {
    EndIf(!EventFlag(1049308011)); //end if boss not selected
    ...
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307411);
});
...
$Event(13002850, Restart, function() {
    EndIf(!EventFlag(1049308042)); //end if boss not selected
    ...
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307442);
});
