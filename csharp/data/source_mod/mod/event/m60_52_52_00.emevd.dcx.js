...
$Event(200, Default, function() {
    $InitializeEvent(0, 1052520800);
    $InitializeEvent(0, 1052522810);
    $InitializeEvent(0, 1052522811);
    $InitializeEvent(0, 1052522812);
    ...
    $InitializeEvent(0, 1052522817);
    $InitializeEvent(0, 1052522849);
});

//fire giant
$Event(1052520800, Restart, function() {
    EndIf(!EventFlag(1049308008) && !EventFlag(1049309712) && !EventFlag(1049309713)); //end if boss not selected
    ...
    if (EventFlag(1049308008)) //full fight
        $InitializeCommonEvent(0, 90009810, 1049307408);
    else if (EventFlag(1049309712)) //phase 2 restore hp
        $InitializeCommonEvent(0, 90009810, 1049307712);
    else if (EventFlag(1049309713)) //phase 2 normal hp
        $InitializeCommonEvent(0, 90009810, 1049307713);
});

// 巨人出現イベント -- Giant appearance event
...
L2:
    ...
    if (EventFlag(1049309712) || EventFlag(1049309713)) { //if phase 2 selected
        SetSpEffect(1052520801, 10493040);
    }
...
$Event(1052522811, Restart, function() {
    ...
    if (EventFlag(1049309712)) //if phase 2 & restore hp
        SetSpEffect(1052520800, 10493052);
...
// 巨人覚醒イベント -- Giant Awakening Event
...
// 巨人部位破壊_内側 -- Giant part destruction_inside
$Event(1052522815, Restart, function(npcPartHP, hpThreshold, hpThreshold2, hpThreshold3, hpThreshold4, hpThreshold5, hpThreshold6, hpThreshold7, hpThreshold8, hpThreshold9) {
    EndIf(EventFlag(1252520800));
    EndIf(ThisEventSlot());
    WaitFor(CharacterBackreadStatus(1052520801));
    CreateNPCPart(1052520801, 9, NPCPartType.Part9, npcPartHP, 1, 1.5, false, false);
                            ...
                            if (!EventFlag(1052522822)) {
                                if (!EventFlag(1052522821)) {
                                    if (!EventFlag(1052522820)) {
                                        WaitFor(NPCPartHP(1052520801, 9) <= hpThreshold);
...
// 巨人部位破壊_外側 -- Giant part destruction_outside
$Event(1052522816, Restart, function(npcPartHP, hpThreshold, hpThreshold2, hpThreshold3, hpThreshold4, hpThreshold5, hpThreshold6, hpThreshold7, hpThreshold8, hpThreshold9) {
    EndIf(EventFlag(1252520800));
    EndIf(ThisEventSlot());
    WaitFor(CharacterBackreadStatus(1052520801));
    CreateNPCPart(1052520801, 8, NPCPartType.Part8, npcPartHP, 1, 1.5, false, false);
                            ...
                            if (!EventFlag(1052522832)) {
                                if (!EventFlag(1052522831)) {
                                    if (!EventFlag(1052522830)) {
                                        WaitFor(NPCPartHP(1052520801, 8) <= hpThreshold);
...
// 巨人部位破壊_部位破壊後弱点整理 -- Destruction of giant parts_organizing weak points after destruction of parts
...
// 巨人ボスイベント起動 -- Giant boss event starts
