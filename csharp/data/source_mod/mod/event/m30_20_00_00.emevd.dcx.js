...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 30202800);
    $InitializeEvent(0, 30202810);
    $InitializeEvent(0, 30202811);
    $InitializeEvent(0, 30202829);
    $InitializeCommonEvent(0, 90005616, 30207910, 30202700);
    $InitializeCommonEvent(0, 90005211, 30200200, 30002, 20002, 30202200, 1, 0, 1, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200201, 30002, 20002, 30202201, 1, 0, 1, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200202, 30002, 20002, 30202202, 1, 1, 1, 0, 0, 0);
    $InitializeCommonEvent(0, 90005261, 30200210, 30202200, 1, 0.1, 0);
    $InitializeCommonEvent(0, 90005261, 30200211, 30202200, 1, 0.3, 0);
    $InitializeCommonEvent(0, 90005261, 30200214, 30202257, 1, 0.1, 0);
    $InitializeCommonEvent(0, 90005261, 30200215, 30202257, 1, 0.3, 0);
    $InitializeCommonEvent(0, 90005261, 30200216, 30202257, 1, 0.5, 0);
    $InitializeCommonEvent(0, 90005261, 30200217, 30202257, 1, 0.3, 0);
    $InitializeCommonEvent(0, 90005261, 30200218, 30202257, 1, 0.2, 0);
    $InitializeCommonEvent(0, 90005211, 30200243, 30002, 20002, 30202243, 1, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200244, 30002, 20002, 30202243, 1, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200245, 30002, 20002, 30202243, 1, 2, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200250, 30002, 20002, 30202250, 1, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200251, 30002, 20002, 30202250, 2, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200252, 30000, 20000, 30202250, 2, 2, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005261, 30200253, 30202253, 0, 0.8, 0);
    $InitializeCommonEvent(0, 90005261, 30200254, 30202254, 0, 0.8, 0);
    $InitializeCommonEvent(0, 90005211, 30200255, 30001, 20001, 30202202, 1, 0.1, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 30200256, 30001, 20001, 30202202, 1, 0.3, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005261, 30200257, 30202257, 0, 0.8, 0);
    $InitializeCommonEvent(0, 90005261, 30200260, 30202260, 1, 0.1, 0);
    $InitializeCommonEvent(0, 90005261, 30200261, 30202260, 1, 0.2, 0);
    $InitializeCommonEvent(0, 90005261, 30200262, 30202260, 1, 0.1, 0);
    $InitializeCommonEvent(0, 90005261, 30200263, 30202260, 1, 0.2, 0);
    $InitializeCommonEvent(0, 90005646, 30200800, 30202840, 30202841, 30201840, 30202840, 30, 20, 0, 0);
...
$Event(30202520, Restart, function(eventFlagId, assetEntityId, eventFlagId2) {
...
// 彫像無効化イベント -- Statue nullification event
...
$Event(30202800, Restart, function() {
    EndIf(!EventFlag(1049308129)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307529);
});

// m30_20ボス出現 -- m30_20 boss appears
...
// m30_20ボスイベント起動 -- m30_20 boss event activated
