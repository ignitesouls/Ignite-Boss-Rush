...
$Event(0, Default, function() {
    if (EventFlag(1049308028)) { //if boss selected (smarag)
        ...
        $InitializeEvent(0, 1034452800);
        $InitializeEvent(0, 1034452805);
        $InitializeCommonEvent(0, 90005211, 1034450800, 30000, 20000, 1034452800, 5, 0, 0, 0, 0, 0);
        $InitializeCommonEvent(0, 90005261, 1034450800, 1034452800, 5, 0, -1);
    }
    $InitializeCommonEvent(0, 90005251, 1034450227, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450228, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450229, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450230, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450231, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450223, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450224, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450225, 7, 0, 1701);
    $InitializeCommonEvent(0, 90005251, 1034450226, 7, 0, 1701);
