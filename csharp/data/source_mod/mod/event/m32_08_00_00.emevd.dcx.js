...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 32082800);
    $InitializeEvent(0, 32082810);
    $InitializeEvent(0, 32082811);
    $InitializeEvent(0, 32082849);
    $InitializeEvent(0, 32082580);
    $InitializeCommonEvent(0, 90005520, 32080588, 32081586, 32080586, 32080587);
    $InitializeEvent(0, 32082498);
    $InitializeCommonEvent(0, 90005646, 32080800, 32082840, 32082841, 32081840, 32082840, 32, 8, 0, 0);
    $InitializeEvent(0, 32082650);
...
$Event(32082200, Restart, function(chrEntityId, animationId, animationId2, timeSeconds, value, value2, value3, value4, assetEntityId, assetEntityId2, assetEntityId3, assetEntityId4) {
    EndIf(ThisEventSlot());
    if (value != 0) {
...
$Event(32082800, Restart, function() {
    EndIf(!EventFlag(1049308158)); //end if boss not selected
    ...
    InitializeCommonEvent(0, 90001033, 1049304149, 1049304164, -1, -1, 1049304618, 1049304619, 1049304620, 1049304621, -1, 1049304765, 1049304767, 1049304770, 1049300149);
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307558);
});
