...
$Event(0, Default, function() {
    ...
    //init boss reward
    $InitializeEvent(0, 12039990);
});

//siluria
$Event(12039990, Default, function() {
    EndIf(!EventFlag(1049308041)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307441);
});
...
$Event(12032500, Restart, function() {
    EndIf(EventFlag(6001)); //end always
...
$Event(12032800, Restart, function() {
    EndIf(!EventFlag(1049308032)); //end if boss not selected
    ...
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307432);
    EndEvent(); //end
...
$Event(12032859, Restart, function() {
    ...
    //move forward to begin battle
    if (EventFlag(1049308005) || EventFlag(1049309720) || EventFlag(1049309721)) {
        DisplayBlinkingMessage(2081023);
    }
    WaitFor(PlayerIsInOwnWorld() && InArea(10000, 12032801));
    SetEventFlagID(9021, ON);
...
L10:
    EndIf(!EventFlag(1049308005) && !EventFlag(1049309720) && !EventFlag(1049309721)); //end if boss not selected
    ...
    InitializeCommonEvent(0, 90001036, 1049304217, 1049307040, 1049304925, 1049304926, 1049304927, 1049304928, 1049304929, 1049304930, 1049304931, 1049305578, 1049305581, 1049305583, 1049305585, 1049305589, 1049305591, 1049305593, 1049300217);
    //boss defeat and warp
    if (EventFlag(1049308005)) //full fight
        $InitializeCommonEvent(0, 90009810, 1049307405);
    else if (EventFlag(1049309720)) //phase 2 restore hp
        $InitializeCommonEvent(0, 90009810, 1049307720);
    else if (EventFlag(1049309721)) //phase 2 normal hp
        $InitializeCommonEvent(0, 90009810, 1049307721);
    EndEvent(); //end
...
L0:
    ...
    if (EventFlag(1049309720) || EventFlag(1049309721)) { //if phase 2 selected
        SetSpEffect(12030850, 10493043);
    ...
    if (EventFlag(1049309720)) { //if phase 2 & restore hp
        WaitFor(EventFlag(12032852));
        SetSpEffect(12035850, 10493050);
    }
});
