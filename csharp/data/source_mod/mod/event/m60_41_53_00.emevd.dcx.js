...
$Event(0, Default, function() {
    if (EventFlag(1049308075)) { //if boss selected (wormface)
...
$Event(50, Default, function() {
    $InitializeCommonEvent(0, 90005261, 1041530362, 1041532362, 3, 0, 3010);
    $InitializeCommonEvent(0, 90005200, 1041530365, 30000, 20000, 1041532365, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 1041530357, 30001, 20001, 1041532357, 0.5, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005250, 1041530361, 1041532361, 0, 3011);
    $InitializeCommonEvent(0, 90005201, 1041530800, 30000, 20000, 15, 0, 0, 0, 0, 0);
});
