...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90005780, 12020800, 12022160, 12022161, 12020715, SummonSignType.NPCWhiteSign, 12022716, 0, true, 0); //enable summon sign visibility
    $InitializeCommonEvent(0, 90005781, 12020800, 12022160, 12022161, 12020715);
    $InitializeEvent(0, 12022699);
    $InitializeEvent(0, 12022698);
    //init boss reward
    $InitializeEvent(0, 12029990);
});
...
$Event(12029990, Default, function() {
    ...
    $InitializeCommonEvent(0, 90009810, 1049307431);
});
...
$Event(12022850, Restart, function() {
    EndIf(!EventFlag(1049308029)); //end if boss not selected
    ...
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307429);
    EndEvent(); //end
...
$Event(12022800, Restart, function() {
    EndIf(!EventFlag(1049308036)); //end if boss not selected
    EndIf(EventFlag(12020800));
    ...
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307436);
    EndEvent(); //end
