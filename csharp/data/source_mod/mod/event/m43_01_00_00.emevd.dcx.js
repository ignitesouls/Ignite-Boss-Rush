...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 43012800);
    $InitializeEvent(0, 43012810);
    $InitializeEvent(0, 43012811);
    $InitializeEvent(0, 43012849);
    $InitializeCommonEvent(0, 90005251, 43010300, 10, 0, 0);
    $InitializeCommonEvent(0, 90005250, 43010200, 43012200, 1, 0);
    $InitializeCommonEvent(0, 90005250, 43010201, 43012201, 0, 3014);
    $InitializeCommonEvent(0, 90005261, 43010209, 43012209, 15, 0, 0);
    $InitializeCommonEvent(0, 90005261, 43010304, 43012304, 30, 0, 0);
    $InitializeCommonEvent(0, 90005200, 43010205, 30014, 20014, 43012205, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 43010206, 30014, 20014, 43012205, 0.5, 0, 0, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005646, 43010800, 43012840, 43012841, 43011840, 43012840, 43, 1, 0, 0);
    $InitializeEvent(0, 43012500);
...
$Event(43012800, Restart, function() {
    EndIf(!EventFlag(1049308200)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307600);
});
