...
$Event(0, Default, function() {
    $InitializeCommonEvent(0, 9005810, 25000800, 25000000, 25000950, 25001950, 5);
    $InitializeEvent(0, 25002800);
    $InitializeEvent(0, 25002810);
    $InitializeEvent(0, 25002849);
    $InitializeEvent(0, 25002812);
    $InitializeEvent(0, 25002811);
    $InitializeEvent(0, 25002819);
...
$Event(25000700, Restart, function(eventFlagId, eventFlagId2) {
...
$Event(25000701, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5) {
    WaitFixedTimeFrames(1);
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    WaitFor(EventFlag(eventFlagId2));
...
$Event(25002800, Restart, function() {
    EndIf(!EventFlag(1049308174) && !EventFlag(1049309728) && !EventFlag(1049309729)); //end if boss not selected
    EndIf(EventFlag(25000800));
    ...
    InitializeCommonEvent(0, 90001046, 1049304303, 1049304154, 1049304158, 1049307316, 1049307317, 1049307318, 1049307319, 1049307320, 1049307321, 1049307322, 1049306619, 1049306623, 1049306626, 1049306631, 1049306633, 1049306635, 1049306637, 1049300303);
    //boss defeat and warp
    if (EventFlag(1049308174)) //full fight
        $InitializeCommonEvent(0, 90009810, 1049307574);
    else if (EventFlag(1049309728)) //phase 2 restore hp
        $InitializeCommonEvent(0, 90009810, 1049307728);
    else if (EventFlag(1049309729)) //phase 2 normal hp
        $InitializeCommonEvent(0, 90009810, 1049307729);
});
...
L0:
    ...
    if (EventFlag(1049309728) || EventFlag(1049309729)) //if phase 2 selected
        SetSpEffect(25000800, 10493044);
    DisplayBossHealthBar(Enabled, 25000800, 0, 905200000);
    if (EventFlag(1049309728)) { //if phase 2 & restore hp
        WaitFor(EventFlag(25002802));
        SetSpEffect(25000800, 10493050);
    }
});
...
$Event(25002820, Restart, function(chrEntityId, eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFor(CharacterDead(chrEntityId) && EventFlag(eventFlagId));
