...
$Event(0, Default, function() {
    $InitializeEvent(0, 2046412800);
    $InitializeEvent(0, 2046412810);
    $InitializeEvent(0, 2046412849);
    $InitializeCommonEvent(0, 900005610, 2046411550, 100, 800, 0);
});

//knight of the solitary gaol
$Event(2046412800, Restart, function() {
    EndIf(!EventFlag(1049308198)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307598);
});
