...
$Event(0, Default, function() {
    $InitializeEvent(0, 2046382800);
    $InitializeEvent(0, 2046382810);
    $InitializeEvent(0, 2046382849);
    $InitializeCommonEvent(0, 90005201, 2046380210, 30001, 20001, 12, 0, 0, 0, 0, 0);
...
$Event(2046382800, Restart, function() {
    EndIf(!EventFlag(1049308182)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307582);
});
