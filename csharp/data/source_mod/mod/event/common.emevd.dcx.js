...
$Event(0, Default, function() {
    $InitializeEvent(0, 1081250000); //max out flasks
    $InitializeEvent(0, 1081250001); //enable dlc+ flag if consort defeated, ng+ and prog
    $InitializeEvent(0, 1081250002); //set dlc+ flag by default in ng+ sandbox
    $InitializeEvent(0, 789290400); //automatic lantern (set flag)
    $InitializeEvent(0, 789290401); //automatic lantern (check flag)
    $InitializeEvent(0, 789290404); //set respawn type
    $InitializeEvent(0, 789290410); //show warning message if existing char is loaded
    $InitializeEvent(0, 789290411); //various
    $InitializeEvent(0, 789290412); //failsafe warp to roundtable if player died after boss defeat
    $InitializeEvent(0, 789290413); //memory of grace: return to roundtable
    $InitializeEvent(0, 789290414); //enable rune loss prevention flag by default
    $InitializeEvent(0, 789290415); //enable normal difficulty by default
...
$Event(50, Default, function() {
    //mode switch check
    if (EventFlag(1049300000) && !EventFlag(1049300057)) //if char initialized and prog flag is off
        DisplayFullScreenMessage(1049300003);
    //currently in progression mode
    SetEventFlagID(1049300057, ON);
...
//various
$Event(789290411, Default, function() {
    EndIf(!EventFlag(1049300000)); //end if not initialized
    //no rune loss
    if (EventFlag(1049300065))
        SetSpEffect(10000, 4290);
    //recovery in every map
    BonfirelikeRecovery();
    //apply inf hp/fp/stamina cheats in sandbox mode
    if (!EventFlag(1049300057)) {
        ...
        //clear cheats in progression mode
        ClearSpEffect(10000, 10493010);
        ClearSpEffect(10000, 10493020);
        ClearSpEffect(10000, 10493030);
    }
    //set default item drop randomization flag if none set
    if (!EventFlag(1049300055) && !EventFlag(1049300061) && !EventFlag(1049300062) && !EventFlag(1049300063)) {
        SetEventFlagID(1049300055, ON);
    }
    //set dlc and underground map toggle flags
    SetEventFlagID(82001, ON);
    SetEventFlagID(82002, ON);  
    SetEventFlagID(9106, OFF); //gideon flag patch
    //apply difficulty setting
    if (EventFlag(1049300501)) { //hard
        ClearSpEffect(10000, 10493061);
        SetSpEffect(10000, 10493060);
    }
    else if (EventFlag(1049300502)) { //very hard
        ClearSpEffect(10000, 10493060);
        SetSpEffect(10000, 10493061);
    }
    else if (EventFlag(1049300503)) { //normal
        ClearSpEffect(10000, 10493060);
        ClearSpEffect(10000, 10493061);
    }
});

//failsafe warp to roundtable if player died after boss defeat
$Event(789290412, Default, function() {
    if (EventFlag(1049300408)) {
        SetEventFlagID(1049300408, OFF);
        if (!PlayerInMap(11, 10, 0, 0))
            WarpPlayer(11, 10, 0, 0, 11100000, -1);
    }
});

//memory of grace: return to roundtable
$Event(789290413, Default, function() {
    WaitFor(CharacterHasSpEffect(10000, 3227));
    WarpPlayer(11, 10, 0, 0, 11100000, -1);
});

//enable rune loss prevention flag by default
$Event(789290414, Default, function() {
    EndIf(EventFlag(1049300066));
    SetEventFlagID(1049300065, ON);
    SetEventFlagID(1049300066, ON);
});

//enable normal difficulty by default
$Event(789290415, Default, function() {
    EndIf(EventFlag(1049300067));
    SetEventFlagID(1049300503, ON);
    SetEventFlagID(1049300067, ON);
});

//max out flasks
$Event(1081250000, Restart, function() {
    WaitFor(EventFlag(1049302400));
    SetEventFlagID(1049302400, OFF);
    RemoveItemFromPlayer(ItemType.Goods, 1000, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1001, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1002, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1003, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1004, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1005, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1006, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1007, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1008, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1009, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1010, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1011, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1012, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1013, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1014, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1015, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1016, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1017, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1018, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1019, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1020, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1021, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1022, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1023, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1024, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1025, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1050, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1051, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1052, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1053, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1054, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1055, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1056, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1057, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1058, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1059, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1060, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1061, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1062, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1063, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1064, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1065, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1066, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1067, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1068, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1069, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1070, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1071, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1072, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1073, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1074, 14);
    RemoveItemFromPlayer(ItemType.Goods, 1075, 14);
    if (EventFlag(1049302401)) {
        AwardItemLot(1049300000);
    } else if (EventFlag(1049302402)) {
        AwardItemLot(1049300005);
    } else if (EventFlag(1049302403)) {
        AwardItemLot(1049300010);
    } else if (EventFlag(1049302404)) {
        AwardItemLot(1049300015);
    } else if (EventFlag(1049302405)) {
        AwardItemLot(1049300020);
    } else if (EventFlag(1049302406)) {
        AwardItemLot(1049300025);
    } else if (EventFlag(1049302407)) {
        AwardItemLot(1049300030);
    } else if (EventFlag(1049302408)) {
        AwardItemLot(1049300035);
    } else if (EventFlag(1049302409)) {
        AwardItemLot(1049300040);
    } else if (EventFlag(1049302410)) {
        AwardItemLot(1049300045);
    } else if (EventFlag(1049302411)) {
        AwardItemLot(1049300050);
    } else if (EventFlag(1049302412)) {
        AwardItemLot(1049300055);
    } else if (EventFlag(1049302413)) {
        AwardItemLot(1049300060);
    } else if (EventFlag(1049302414)) {
        AwardItemLot(1049300065);
    } else if (EventFlag(1049302415)) {
        AwardItemLot(1049300070);
    }
});

//enable dlc+ flag in prog
$Event(1081250001, Default, function() {
    EndIf(!EventFlag(1049300000)); //end if not initialized
    EndIf(!EventFlag(1049300057) || EventFlag(70)); //end if sandbox mode or dlc+ already on
    if (EventFlag(1049304305)) { //if consort defeated
        SetEventFlagID(70, ON);
    }
});

//set dlc+ flag by default in ng+ sandbox
$Event(1081250002, Default, function() {
    EndIf(!EventFlag(1049300000)); //end if not initialized
    EndIf(EventFlag(1049300403));
    if (GameCycle() >= 1 && !EventFlag(1049300057))
      SetEventFlagID(70, ON);
    SetEventFlagID(1049300403, ON);
});

//automatic lantern (set flag)
$Event(789290400, Restart, function() {
    WaitFor(CharacterHasSpEffect(10000, 3245));
    SetEventFlagID(1049310020, ON);
    WaitFor(!CharacterHasSpEffect(10000, 3245));
    SetEventFlagID(1049310020, OFF);
    RestartEvent();
});

//automatic lantern (check flag)
$Event(789290401, Restart, function() {
    if (EventFlag(1049310020)) {
        SetSpEffect(10000, 3245);
    }
});

//set respawn type
$Event(789290404, Default, function() {
    EndIf(!EventFlag(1049300000)); //end if not initialized
    if (PlayerInMap(11, 10, 0, 0) || EventFlag(1049300404)) { //if at roundtable or boss has stake of marika
        SetPlayerRespawnPoint(11102021); //set respawn to roundtable
        SaveRequest();
    }
    else if (EventFlag(1049300052) //if local respawn option is enabled
    || EventFlag(1049300060)) { //or if a sequential mode is active
        SetEventFlagID(1049300404, OFF); //reset stake of marika flag
        $InitializeEvent(0, 789290405); //set specific respawn point based on boss selected
        $InitializeEvent(0, 789290406);
        $InitializeEvent(0, 789290407);
        WaitFor(AllBatchEventFlags(1049302435, 1049302437)) //wait for events to run
        SaveRequest();
        EndEvent();
    }
});
...
//set respawn point 1
$Event(789290405, Default, function() {
    //Beast Clergyman / Maliketh
    if (EventFlag(1049308009))
    ...
    SetEventFlagID(789290405, ON);
});

//set respawn point 2
$Event(789290406, Default, function() {
    //Omenkiller (Liurnia)
    if (EventFlag(1049308066))
    ...
    SetEventFlagID(789290406, ON);
});

//set respawn point 3
$Event(789290407, Default, function() {
    //Bayle the Dread (phase 2)
    if (EventFlag(1049309700))
        SetPlayerRespawnPoint(2054392099);
    else if (EventFlag(1049309701))
        SetPlayerRespawnPoint(2054392099);
    //Beast Clergyman / Maliketh (p2)
    ...
    //Commander Gaius (p2)
        ...
        SetPlayerRespawnPoint(2049482099);
    //Divine Beast Dancing Lion (p2)
    else if (EventFlag(1049309706))
        SetPlayerRespawnPoint(20000099);
    else if (EventFlag(1049309707))
        SetPlayerRespawnPoint(20000099);
    //Dragonkin Soldier of Nokstella (p2)
    else if (EventFlag(1049309708))
        SetPlayerRespawnPoint(12010098);
    else if (EventFlag(1049309709))
        SetPlayerRespawnPoint(12010098);
    //Dragonlord Placidusax (p2)
...
L0:
    //ChangeWeather(Weather.PuffyClouds, -1, true); //disable weather change in limgrave start
...
L0:
    ...
    SetEventFlagID(101, ON);
    //if (EventFlag(9990)) { //disable weather change in limgrave start
...
$Event(1600, Default, function(eventFlagId, eventFlagId2, assetEntityId, assetEntityId2) {
    ...
    if (!PlayerIsInOwnWorld()) {
        ...
        WaitFor(AssetBackread(assetEntityId2, Equal, 1));
