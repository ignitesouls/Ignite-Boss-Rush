...
$Event(0, Default, function() {
    $InitializeCommonEvent(0, 9005810, 2052430800, 10000, 2052430950, 2052431950, 5);
    $InitializeEvent(0, 2052432800);
    $InitializeEvent(0, 2052432810);
    $InitializeEvent(0, 2052432816);
    $InitializeEvent(0, 2052432849);
...
$Event(2052432800, Restart, function() {
    EndIf(!EventFlag(1049308199)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307599);
});
...
$Event(2052432820, Restart, function(chrEntityId) {
    EndIf(EventFlag(2052430800));
    WaitFor(CharacterHPValue(2052430800) <= 0);
    if (CharacterHasSpEffect(chrEntityId, 20013255)) {
