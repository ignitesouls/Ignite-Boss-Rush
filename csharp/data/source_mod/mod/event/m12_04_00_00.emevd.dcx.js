...
$Event(0, Default, function() {
    $InitializeCommonEvent(0, 9005810, 12040800, 71240, 12040950, 12041950, 5);
    $InitializeEvent(0, 12042680);
    $InitializeEvent(0, 12042400);
    $InitializeEvent(0, 12042849);
    $InitializeEvent(0, 12042800);
    $InitializeEvent(0, 12042810);
});

// 透明壁_ラニイベント用 -- Transparent wall_for Rani event
...
$Event(12042800, Default, function() {
    EndIf(!EventFlag(1049308004)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307404);
});

// アステール出現 -- Aster appears
...
// アステール戦イベント起動 -- Aster battle event starts
