...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(2, 90005200, 30130253, 30000, 20000, 30132251, 0.2, 0, 0, 0, 0);
    $InitializeCommonEvent(3, 90005200, 30130254, 30000, 20000, 30132251, 0.5, 0, 0, 0, 0);
    $InitializeCommonEvent(4, 90005200, 30130255, 30000, 20000, 30132251, 0.3, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 30130256, 30000, 20000, 30132256, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(1, 90005200, 30130257, 30000, 20000, 30132256, 0.3, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005250, 30130270, 30132270, 0, 0);
    $InitializeCommonEvent(1, 90005250, 30130271, 30132270, 0, 0);
    $InitializeCommonEvent(1, 90005200, 30130275, 30000, 20000, 30132405, 0.3, 0, 0, 0, 0);
    $InitializeCommonEvent(2, 90005200, 30130276, 30000, 20000, 30132405, 0.5, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005250, 30130297, 30132297, 3, 0);
    ...
    $InitializeCommonEvent(2, 90005200, 30130402, 30000, 20000, 30132400, 0.5, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 30130407, 30000, 20000, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 30130408, 30000, 20000, 30132408, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005250, 30130300, 30132300, 0, 3006);
    $InitializeCommonEvent(0, 90005200, 30130301, 30000, 20000, 30132301, 0.2, 0, 0, 0, 0);
    $InitializeCommonEvent(1, 90005200, 30130302, 30000, 20000, 30132302, 0.4, 0, 0, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005261, 30130315, 30132315, 5, 0, 0);
    $InitializeCommonEvent(0, 90005250, 30130312, 30132312, 0, 0);
    $InitializeCommonEvent(0, 90005200, 30130316, 30010, 20010, 30132316, 5, 0, 0, 0, 0);
    $InitializeCommonEvent(1, 90005200, 30130317, 30003, 20003, 30132317, 2, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005250, 30130318, 30132318, 0, 3006);
    $InitializeCommonEvent(0, 90005251, 30130320, 4, 0, 0);
    ...
    $InitializeEvent(0, 30132510);
    $InitializeCommonEvent(0, 90005525, 30130570, 30131570);
    $InitializeEvent(0, 30132580);
    $InitializeEvent(0, 30132800);
    $InitializeEvent(0, 30132810);
    $InitializeEvent(0, 30132849);
    $InitializeEvent(0, 30132811);
    $InitializeCommonEvent(0, 90005200, 30130292, 30000, 20000, 30132800, 1, 0, 0, 0, 0);
    $InitializeCommonEvent(1, 90005200, 30130293, 30000, 20000, 30132800, 1.2, 0, 0, 0, 0);
    $InitializeCommonEvent(2, 90005200, 30130298, 30000, 20000, 30132800, 0.8, 0, 0, 0, 0);
    $InitializeCommonEvent(3, 90005200, 30130299, 30000, 20000, 30132800, 1.5, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005646, 30130800, 30132840, 30132841, 30131840, 30132840, 30, 13, 0, 0);
...
// 宝箱ワープイベント_XX -- Treasure chest warp event_XX
$Event(30132200, Restart, function(assetEntityId, assetEntityId2, areaEntityId, chrEntityId, eventFlagId, objactEventFlag) {
    if (!EventFlag(eventFlagId)) {
        ...
        if (CharacterHPValue(10000) != 0) {
            ...
            WarpCharacterAndCopyFloorWithFadeout(10000, TargetEntityType.Area, chrEntityId, -1, 10000, false, true);
...
// 宝箱ワープ用特殊効果付与用イベント_XX -- Event for adding special effects for treasure chest warp_XX
$Event(30132205, Restart, function(eventFlagId, areaEntityId) {
...
$Event(30130790, Restart, function(assetEntityId, eventFlagId) {
    EndIf(ThisEventSlot());
...
$Event(30132800, Restart, function() {
    EndIf(!EventFlag(1049308122)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307522);
});
...
// 剣闘士_イベント起動 -- Gladiator_event activation
...
// ナズグル2_イベント起動 -- Nazgul 2_event activation
