...
$Event(0, Default, function() {
    if (EventFlag(1049308201)) { //if boss selected (divine beast dancing lion)
    ...
    $InitializeEvent(0, 2046462814);
    $InitializeEvent(0, 2046462811);
    $InitializeEvent(0, 2046462815);
    $InitializeEvent(0, 2046462816);
    $InitializeEvent(0, 2046462830);
    ...
    $InitializeCommonEvent(0, 90005301, 2046460290, 2046460290, 2046460000, 3, 0);
...
$Event(2046462817, Restart, function(chrEntityId) {
    if (EventFlag(2046460800)) {
        EndEvent();
    }
L0:
    ...
    WaitFor(CharacterHasSpEffect(chrEntityId, 20011217) && InArea(chrEntityId, 2046462800));
    WaitFixedTimeRealFrames(1);
    if (InArea(chrEntityId, 2046462810)) {
...
L1:
        if (InArea(chrEntityId, 2046462820)) {
...
L2:
            if (InArea(chrEntityId, 2046462830)) {
...
L3:
                if (InArea(chrEntityId, 2046462840)) {
...
L4:
                    if (InArea(chrEntityId, 2046462850)) {
...
L5:
                        if (InArea(chrEntityId, 2046462860)) {
...
L6:
                            if (InArea(chrEntityId, 2046462870)) {
...
L7:
                                if (InArea(chrEntityId, 2046462880)) {
...
$Event(2046462820, Restart, function(eventFlagId, generatorEntityId) {
    if (EventFlag(2046460800)) {
...
$Event(2046462840, Restart, function(chrEntityId) {
    EndIf(EventFlag(2046460800));
    WaitFor(CharacterBackreadStatus(chrEntityId) && EventFlag(2046462830));
