...
$Event(0, Default, function() {
    $InitializeEvent(0, 1033422211);
    $InitializeEvent(0, 1033422611);
    $InitializeCommonEvent(0, 90005300, 1033420610, 1033420610, 0, 0, 0);
    if (EventFlag(1049308106)) { //if boss selected (alecto)
        $InitializeCommonEvent(0, 90005880, 1033420800, 1033420805, 1033422800, 1033420800, 30265, 60, 33, 42, 0, 1033422805);
        $InitializeCommonEvent(0, 90005881, 1033420800, 1033420805, 1033422801, 1033422802, 20300, 1033421805, 60, 33, 42, 0, 1033422805);
