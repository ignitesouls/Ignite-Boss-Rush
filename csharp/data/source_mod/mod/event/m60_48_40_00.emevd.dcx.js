...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 1048402800);
    $InitializeEvent(0, 1048402810);
    $InitializeEvent(0, 1048402849);
...
$Event(1048402800, Restart, function() {
    EndIf(!EventFlag(1049308159)); //end if boss not selected
    ...
    InitializeCommonEvent(0, 90001034, 1049304151, 1049304058, -1, 1049304004, 1049304626, 1049304627, 1049304628, 1049304629, 1049304630, -1, 1049304786, 1049304788, 1049304791, 1049304795, 1049300151);
    //boss defeat and warp
    $InitializeCommonEvent(0, 90009810, 1049307559);
});
