...
$Event(0, Default, function() {
    $InitializeCommonEvent(0, 9005810, 1043300800, 76161, 1043300950, 1043301950, 5);
    $InitializeEvent(0, 1043302800);
    $InitializeEvent(0, 1043302810);
    $InitializeEvent(0, 1043302849);
    $InitializeCommonEvent(0, 90005780, 1043300800, 1043302701, 1043302161, 1043300700, SummonSignType.NPCWhiteSign, 1043302701, 0, true, 0); //enable summon visibility
...
$Event(50, Default, function() {
    $InitializeCommonEvent(0, 90005200, 1043300340, 30001, 20001, 1043302340, 0.5, 0, 0, 0, 0);
});

// ランダム敵生成 -- random enemy generation
...
$Event(1043302800, Restart, function() {
    EndIf(!EventFlag(1049308017)); //end if boss not selected
    ...
    $InitializeCommonEvent(0, 90009810, 1049307417);
});
...
// ボス戦_イベント起動 -- Boss battle_event activation
