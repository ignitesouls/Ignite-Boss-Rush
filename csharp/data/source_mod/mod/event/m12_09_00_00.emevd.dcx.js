...
$Event(12092800, Default, function() {
    EndIf(!EventFlag(1049308002)); //end if boss not selected
    ...
    InitializeCommonEvent(0,90001033,1049304188, 1049307030,-1,1049304087,1049304800,1049304801,1049304802,1049304803,1049305241,1049305246,1049305251,1049305253,1049300188);
    //boss defeat and warp
    InitializeCommonEvent(0, 90009810, 1049307402);
});
