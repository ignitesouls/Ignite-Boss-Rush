...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90005211, 1043530354, 30005, 20021, 1043532350, 3, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 1043530355, 30005, 20021, 1043532350, 3, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 1043530350, 30000, 20000, 1043532350, 3, 0, 0, 0, 0, 0);
    if (EventFlag(1049308078)) { //if boss selected (bell bearing hunter)
...
$Event(50, Default, function() {
    ...
    $InitializeCommonEvent(0, 90005211, 1043530202, 30016, 20016, 1043532203, 3, 0, 0, 0, 0, 0);
    ...
    $InitializeCommonEvent(0, 90005211, 1043530206, 30014, 20014, 1043532206, 8, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005211, 1043530207, 30014, 20014, 1043532206, 8, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005200, 1043530208, 30014, 20014, 1043532208, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530218, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530219, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530221, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530222, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530228, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530229, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530209, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530210, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530211, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530214, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530215, 30014, 20014, 5, 0, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90005201, 1043530216, 30014, 20014, 5, 0, 0, 0, 0, 0);
...
// NPC801モブ赤目09_NPC初期化イベント -- NPC801 mob red eye 09_NPC initialization event
$Event(1043530700, Restart, function(chrEntityId, chrEntityId2, assetEntityId) {
    DisableNetworkSync();
