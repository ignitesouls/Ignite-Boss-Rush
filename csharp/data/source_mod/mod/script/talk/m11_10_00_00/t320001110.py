...
def t320001110_x1():
    ...
    while True:
        ...
        call = t320001110_x5(actionbutton1=6000, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=6000)
        if call.Done():
            """State 2"""
            assert t320001110_x3() or (GetDistanceToPlayer() > 3 or IsMultiplayerInProgress())
        elif IsMultiplayerInProgress():
            pass
        """State 3"""
        assert t320001110_x6() and not IsMultiplayerInProgress()
    """Unused"""
    """State 4"""
    return 0
...
def t320001110_x5(actionbutton1=6000, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=6000):
    """State 0"""
    while True:
        """State 1"""
